    ...
    <div className="p-4 md:p-6 w-full">
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-sm text-ink-3 mt-0.5 font-medium">{models.length} model terdeteksi</p>
        </div>
      ...
      {models.length === 0 ? (
        <div className="bg-bg-3 border-2 border-dashed border-border rounded-xl flex flex-col items-center justify-center p-12 text-center hover:border-accent/40 transition-all cursor-pointer group" onClick={() => navigate('/integrations')}>
          ...
          <h2 className="text-lg font-semibold text-ink mb-2">Belum ada model aktif terdeteksi</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          >
            ...
            <span className="text-sm text-ink-3 group-hover:text-ink transition-colors font-semibold">Tambah model baru</span>
            <span className="text-xs text-accent-2 mt-1 font-semibold">Buka halaman Integrasi →</span>
          </div>
        </div>
      )}
      ...
      <div className="mt-6 bg-bg-3 border border-border rounded-xl p-5">
        <h2 className="text-base font-semibold text-ink mb-4">🦙 Panduan Ollama (Model Lokal Gratis)</h2>
